...
export default class Blog extends Component {
  ...
  getBlogItems() {
    ...
    axios.get(`https://toasty.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, { withCredentials: true })
      .then(res => {
        this.setState({
      ...
      .catch(err => {
        console.log('Error, from getBlogItems', err);
      })
  }
